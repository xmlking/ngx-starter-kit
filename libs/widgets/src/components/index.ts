export { WidgetComponent } from '../components/widgets-v1/widget-v1/widget-v1.component';
export { LineChartWidgetComponent } from '../components/widgets-v1/line-chart-widget/line-chart-widget.component';
export {
  SourceOverviewWidgetComponent
} from '../components/widgets-v1/source-overview-widget/source-overview-widget.component';
...
export { D3ChartService } from '../components/charts/nvD3/nvD3.service';
